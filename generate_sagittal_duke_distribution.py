...
def main():
    ...
    ax.set_title('Duke-Full Dataset Distribution (Sagittal MIP)', fontsize=10)
    ax.set_xticks(x)
    ...
    plot_path = os.path.join(out_dir, 'duke_sagittal_distribution.png')
    plt.savefig(plot_path, dpi=300)
    plt.close()
    
    shutil.copy2(plot_path, os.path.join(artifact_dir, 'duke_sagittal_distribution.png'))
