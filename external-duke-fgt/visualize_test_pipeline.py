...
def load_config():
    config_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'config_test.json'))
...
def main():
    ...
    if not test_subjects:
        print("No test subjects defined.")
        return

    out_figs_dir = os.path.join(config["DATA_DIR"], "test_visuals")
