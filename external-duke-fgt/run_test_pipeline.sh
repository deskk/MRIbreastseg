...
ln -s external-duke-fgt/config_test.json config.json
...
# --- Phase 0 ---
if [ -f external-duke-fgt/.test_phase0.done ]; then
    ...
    touch external-duke-fgt/.test_phase0.done
fi

# --- Phase 1 ---
if [ -f external-duke-fgt/.test_phase1.done ]; then
    ...
    touch external-duke-fgt/.test_phase1.done
fi

# --- Phase 2 ---
if [ -f external-duke-fgt/.test_phase2.done ]; then
    ...
    python pipeline/phase2_mama-mia/scripts/postprocess_filter_noise.py
    touch external-duke-fgt/.test_phase2.done
fi

# --- Phase 3 ---
if [ -f external-duke-fgt/.test_phase3.done ]; then
    ...
    cd ../../../
    touch external-duke-fgt/.test_phase3.done
fi

# --- Phase 4 ---
if [ -f external-duke-fgt/.test_phase4.done ]; then
    ...
    touch external-duke-fgt/.test_phase4.done
fi

# --- Phase 5 ---
if [ -f external-duke-fgt/.test_phase5.done ]; then
    ...
    touch external-duke-fgt/.test_phase5.done
fi
